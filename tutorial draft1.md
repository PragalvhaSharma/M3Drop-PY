...
![Dispersion vs Mean plot for Human Heart dataset](tutorial_png/Human Heart_disp_vs_mean.png)
...
![Model Comparison plot for Human Heart dataset](tutorial_png/Human Heart_NBumiCompareModels.png)
